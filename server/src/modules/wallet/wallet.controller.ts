...
export class WalletController {
  ...
  @ApiOperation({
    ...
    description: 'Returns the current balance and currency of the authenticated user\'s wallet.',
  })
  ...
  @ApiOkResponse({ description: 'Withdrawal successful', type: WalletResponseDto })
  @ApiUnauthorizedResponse({ description: 'Missing or invalid access token' })
  ...
  @ApiOkResponse({ description: 'Transfer successful', type: TransferResponseDto })
  @ApiUnauthorizedResponse({ description: 'Missing or invalid access token' })
