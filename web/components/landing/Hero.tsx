      ...
      <div className="mx-auto max-w-7xl px-6 lg:grid lg:grid-cols-2 lg:gap-12 items-center">
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="font-sora text-5xl font-extrabold leading-none tracking-tight text-foreground md:text-7xl"
          >
          ...
          <motion.p
            ...
            className="mt-6 text-lg text-foreground/40 md:text-xl"
          >
          ...
          >
            ...
            <Link href="#how-it-works" className="w-full sm:w-auto">
              <Button size="lg" variant="ghost" className="w-full gap-2 text-foreground hover:bg-foreground/5">
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 mx-auto w-full max-w-[500px] border border-border bg-background/50 p-6 backdrop-blur-2xl shadow-2xl gold-glow flex flex-col gap-6"
          >
               {/* Balance Card Mock */}
               <div className="relative overflow-hidden border border-border bg-surface text-foreground flex-shrink-0">
                   ...
                   <div className="flex items-start justify-between">
                     <div className="space-y-3">
                       <div className="flex items-center gap-2 text-muted-foreground">
                         ...
                         <div className="bg-foreground/5 p-1.5">
                           <EyeOff size={14} />
                         </div>
                       </div>
