    ...
    <footer className="border-t border-border pt-20 pb-10">
      <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              {['Twitter', 'Instagram', 'LinkedIn'].map(social => (
                <div key={social} className="h-8 w-8 bg-foreground/5 border border-border flex items-center justify-center text-foreground/40 hover:text-primary cursor-pointer transition-colors">
        ...
        <div className="pt-8 border-t border-border text-center">
          <p className="text-sm text-foreground/40">© 2026 SnapPay. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
